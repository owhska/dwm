...
# Configuração dwm com patches + binds ThinkPad
cat <<EOF > config.h
...
echo "==== Atualização automática Arch + AUR (script) ===="
mkdir -p ~/scripts
...
echo ""
echo "==== INSTALL EXTREME COMPLETO ===="
echo "Reinicie e rode: startx"
